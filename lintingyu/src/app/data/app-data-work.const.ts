export const workDatas = [
  {
    ...
    layouts: [
      { layout: 'bigImg',
        imgs: [
          'assets/workImg/toy-2.jpg'
        ]
      },
      { layout: 'imgsAndText',
        layoutType: 1,
        imgs: [
          'assets/workImg/toy-1.jpg',
          'assets/workImg/toy-3.jpg'
        ],
      ...
      { layout: 'imgAndText',
        layoutType: 0,
        imgs: [
          'assets/workImg/toy-4.jpg'
        ],
        text: '盒底的附件，也是台灣古早時候的玩具 "冰鈴機"，是當年雜貨店或是烤魷魚推車必備的玩具，也是大家閒暇之餘，下課遊玩時，測試一下自己運氣的好東西。'
      },
      { layout: 'bigImg',
        imgs: [
          'assets/workImg/toy-5.jpg'
        ]},
      { layout: 'twoBigImg',
        imgs: [
          'assets/workImg/toy-folktoypage-01.jpg',
          'assets/workImg/toy-folktoypage-02.jpg'
        ]
      }
    ]
  },
  {
    ...
    layouts: [
      { layout: 'bigImg',
        imgs: [
          'assets/workImg/food-1.jpg'
        ]
      },
      { layout: 'imgAndText',
        layoutType: 1,
        imgs: [
          'assets/workImg/food-2.jpg'
        ],
      ...
      { layout: 'imgsAndText',
        layoutType: 0,
        imgs: [
          'assets/workImg/food-page1.png',
          'assets/workImg/food-page2.png'
        ],
        text: '以圖片配合插畫，讓讀者不僅能夠對食物有，也可以了解台灣小吃的由來，及食物名稱的趣味原由。'
      },
      { layout: 'twoBigImg',
        imgs: [
          'assets/workImg/food-3.jpg',
          'assets/workImg/food-4.jpg'
        ]
      }
    ]
  },
  {
    ...
    layouts: [
      { layout: 'bigImg',
        imgs: [
          'assets/workImg/sushi-2.jpg'
        ]
      },
      { layout: 'imgAndText',
        layoutType: 0,
        imgs: [
          'assets/workImg/sushi-juice.jpg'
        ],
        text: '以簡約及鮮魚為主。在 "爭鮮" 二字中藏了兩隻魚在其中，魚鰓呈現紅色，象徵新鮮。俐落的線條，使大眾看到有耳目一新的感覺。'
      },
      { layout: 'bigImg',
        imgs: [
          'assets/workImg/sushi-1.jpg'
        ]
      }
    ]
  },
  {
    ...
    layouts: [
      { layout: 'twoBigImg',
        imgs: [
          'assets/workImg/milocca-1.jpg',
          'assets/workImg/milocca-2.jpg',
        ]
      },
      { layout: 'imgsAndText',
        layoutType: 0,
        imgs: [
          'assets/workImg/milocca-card-01.png',
          'assets/workImg/milocca-card-02.png'
        ],
        text: '傳統圖章式的LOGO設計。彷彿看到LOGO就直接聞到傳統手做麵包的香氣。'
      },
      { layout: 'bigImg',
        imgs: [
          'assets/workImg/milocca-something.jpg'
        ]
      }
    ],
  },
  {
    ...
    layouts: [
      { layout: 'bigImg',
        imgs: [
          'assets/workImg/catch-4.jpg'
        ]
      },
      { layout: 'imgAndText',
        layoutType: 0,
        imgs: [
          'assets/workImg/catch-3.jpg'
        ],
        text: '吃傳統包裝的冰棒時，總是因為融化速度過快，導致手變得黏黏的，讓人火大。因此了有這個想法。'
      },
      { layout: 'bigImg',
        imgs: [
          'assets/workImg/catch-2.jpg'
        ]
      }
    ]
  },
  {
    ...
    layouts: [
      { layout: 'bigImg',
        imgs: [
          'assets/workImg/soymilk-1.jpg'
        ]
      },
      { layout: 'imgAndText',
        layoutType: 0,
        imgs: [
          'assets/workImg/soymilk-logo.jpg'
        ],
  ...
  },
  {
    ...
    layouts: [
      { layout: 'bigImg',
        imgs: 'assets/workImg/honor-1.jpg'
      },
      { layout: 'imgAndText',
        layoutType: 1,
        imgs: [
          'assets/workImg/honor-2.jpg'
        ],
  ...
  },
  {
    ...
    layouts: [
      { layout: 'twoBigImg',
        imgs: [
          'assets/workImg/anotherlogo-01-1.jpg',
          'assets/workImg/anotherlogo-01-2.jpg'
        ]
      },
      { layout: 'bigImg',
        imgs: [
          'assets/workImg/anotherlogo-02.jpg'
        ]
      },
      { layout: 'imgsAndText',
        layoutType: 0,
        imgs: [
          'assets/workImg/anotherlogo-03.jpg',
          'assets/workImg/anotherlogo-04.jpg'
        ],
        text: '以編織出的文字，傳達出服飾店"訂製"的特色，每件衣服都是精心編織的結果。'
      },
      { layout: 'bigImg',
        imgs: [
          'assets/workImg/anotherlogo-05.jpg'
        ]
      },
      { layout: 'bigImg',
        imgs: [
          'assets/workImg/anotherlogo-06.jpg'
        ]
      }
    ]
  },
  {
    ...
    layouts: [
      { layout: 'bigImg',
        imgs: [
          'assets/workImg/PSI-guitar.jpg'
        ]
      },
      { layout: 'bigImg',
        imgs: [
          'assets/workImg/psi-2.jpg'
        ]
      },
      { layout: 'imgAndText',
        layoutType: 1,
        imgs: [
          'assets/workImg/psi-3.jpg'
        ],
        text: '以音樂播放鍵為出發點，結合箭頭與 pick 外型。整體以正三角形切格而成，象徵嚴謹的公司理念。箭頭指向右方表示前進、開始。'
      },
      { layout: 'bigImg',
        imgs: [
          'assets/workImg/psi-1.jpg'
        ]
      }
    ]
  },
  {
    ...
    layouts: [
      { layout: 'bigImg',
        imgs: [
          'assets/workImg/kink-1.jpg'
        ]
      },
      { layout: 'imgsAndText',
        layoutType: 0,
        imgs: [
          'assets/workImg/kink-2.jpg',
          'assets/workImg/kink-3.jpg'
        ],
